...
export default function AddActualModal({ 
  isOpen, 
  detailId,
  detailName,
  onClose, 
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) throw new Error('Failed to add actual')
          ...
          >
            ...
            <div className="bg-gradient-to-r from-green-600 to-teal-600 px-6 py-4">
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-white">Add Actual Purchase</h2>
                  <p className="text-green-100 text-sm mt-1">for {detailName}</p>
                </div>
                <button
                  onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(80vh-140px)]">
              ...
              <div className="flex justify-end gap-3 mt-6 pt-6 border-t border-gray-200">
                ...
                >
                  ...
                  {isSubmitting ? 'Adding...' : 'Add Actual'}
                </button>
              </div>
            </form>
          </motion.div>
